...
function AvatarComponent({
  ...
  const [bgColor, textColor] = propColors || (avatarText ? getColorPair(avatarText) : getColorPair('user'));
  ...
  return (
    ...
    >
      <AvatarPrimitive.Image
        ...
        src={imageUrl}
        alt={name}
        className={cn('aspect-square size-full object-cover rounded-md', className)}
      />
