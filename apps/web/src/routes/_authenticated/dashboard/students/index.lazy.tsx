...
import { columns } from '@/features/students/columns';
import { students } from '@/features/students/data';
import { RegisterStudentForm } from '@/features/students/RegisterStudentForm';
import { createLazyFileRoute } from '@tanstack/react-router';
import { DownloadCloud, Filter, Search, UploadCloud } from 'lucide-react';
import { useState } from 'react';

export const Route = createLazyFileRoute('/_authenticated/dashboard/students/')({
      ...
      <Card className="border-0 shadow-none p-4">
        ...
        <CardContent className="p-0">
          ...
          <div className=" overflow-hidden">
            <DataTable columns={columns} data={students} search={search} onSearchChange={setSearch} />
          </div>
        </CardContent>
      </Card>
    </div>
