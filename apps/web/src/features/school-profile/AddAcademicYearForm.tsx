...
export const AddAcademicYearForm = () => {
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      startDate: undefined,
      endDate: undefined,
      terms: [{ startDate: undefined, endDate: undefined }],
    },
  });
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button size="lg">Add Academic Year</Button>
      </DialogTrigger>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Add Academic Year</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 py-4">
            ...
            <DialogFooter className="pt-6">
              ...
              <Button type="submit">
                Add Academic Year <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </DialogFooter>
          </form>
        </Form>
