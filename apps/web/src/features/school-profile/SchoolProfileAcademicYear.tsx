...
export default function SchoolProfileAcademicYear() {
    ...
    <div className="p-4">
      <Card className="border-0 shadow-none p-4">
        <CardHeader className="flex flex-row justify-between items-center pb-6 px-0">
          <h3 className="text-2xl font-medium">Adding Academic Year</h3>
          <div>
            <AddAcademicYearForm />
          </div>
        </CardHeader>
        <CardContent className="p-0">
          ...
          <div className=" overflow-hidden">
            <DataTable columns={academicYearColumns} data={academicYears} search={search} onSearchChange={setSearch} />
          </div>
        </CardContent>
      </Card>
    </div>
